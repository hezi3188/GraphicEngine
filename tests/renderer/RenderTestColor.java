...
class RenderTestColor {
...

    {
        ...
        scene.insertImage(new Sphere(100, new pointD3(0.0, 0.0, -150), new Color(java.awt.Color.RED)));
        scene.insertImage(new Sphere(100, new pointD3(-70.0, 70.0, -150), new Color(java.awt.Color.RED)));
        scene.insertImage(new Sphere(100, new pointD3(70, 70, -150), new Color(java.awt.Color.RED)));
        scene.insertImage(new Sphere(100, new pointD3(70, -70, -150), new Color(java.awt.Color.RED)));
        scene.insertImage(new Sphere(100, new pointD3(-70, -70, -150), new Color(java.awt.Color.RED)));
        ...
        scene.insertLight(new PointLight(new Color(0,255,255),new pointD3(-50, 50, 10),1,0.001,0.001));
