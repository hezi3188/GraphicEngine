...
class RenderTestColor {
...

    {
        ...
        scene.insertImage(new Sphere(100, new pointD3(0.0, 0.0, -150), new Color(java.awt.Color.orange)));

        scene.setFillLight(new AmbientLight(new Color(java.awt.Color.white), 0.01));
        //scene.insertLight(new PointLight(new Color(255,255,255),new pointD3(0.0, 0.0, -20),1,0.001,0.001));
        /*scene.insertLight(
                new SpotLight(
        ...
        scene.insertLight(new PointLight(new Color(255,255,255),new pointD3(110, 110, -10),1,0.01,0.01));
